...
fn string_is_nice_1(s: &str) -> bool {
    ...
    for i in 0usize..s.len() {
        ...
        if i > 0 {
            ...
            if (c == 'b') & (previous_char == 'a') {
                bad_combo = true
            };
            if (c == 'd') & (previous_char == 'c') {
                bad_combo = true
            };
            if (c == 'q') & (previous_char == 'p') {
                bad_combo = true
            };
            if (c == 'y') & (previous_char == 'x') {
                bad_combo = true
            };
        }
    }
...
fn string_is_nice_2(s: &str) -> bool {
    ...
    for i in 0usize..s.len() {
        ...
        if i > 1 {
            ...
            if c == two_letters_back {
                one_letter_gap_pairs = true
            };
        }
    }
